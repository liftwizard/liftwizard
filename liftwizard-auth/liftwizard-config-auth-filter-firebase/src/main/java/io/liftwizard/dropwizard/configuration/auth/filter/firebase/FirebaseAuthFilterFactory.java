...
public class FirebaseAuthFilterFactory implements AuthFilterFactory {
    ...
    public AuthFilter<?, FirebasePrincipal> createAuthFilter() {
        FirebaseAuth firebaseAuthFactory = new FirebaseAuth(this.databaseUrl, this.firebaseConfig);
        ...
        return new Builder<FirebasePrincipal>().setAuthenticator(authenticator).setPrefix("Bearer").buildAuthFilter();
    }

    ...
    void replacePatterns() {
        this.rewriteRun(
                java(
                    ...
                    class Test {
                        private SortedMap<String, Integer> fieldSortedMap = SortedMaps.mutable.empty();
                    ...
                    class Test {
                        private MutableSortedMap<String, Integer> fieldSortedMap = SortedMaps.mutable.empty();

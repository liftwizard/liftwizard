...
class ECListConstructorToFactoryTest implements RewriteTest {
    ...
    void explicitGenericsAreTransformed() {
        this.rewriteRun(
                java(
                    ...
                    class Test {
                        void test() {
                            FastList<String> list = Lists.mutable.<String>empty();
                        }
                    }
                    """
                )
    ...
    @Test
    void explicitGenericsWithMultipleTypeParameters() {
        this.rewriteRun(
                java(
                    """
                    import org.eclipse.collections.impl.list.mutable.FastList;
                    ...
                    class Test {
                        void test() {
                            FastList<Map<String, Integer>> list = new FastList<Map<String, Integer>>();
                        }
                    }
                    """,
                    """
                    ...
                    class Test {
                        void test() {
                            FastList<Map<String, Integer>> list = Lists.mutable.<Map<String, Integer>>empty();
                        }
                    }
                    """
                )

...
class IterateToArrayIterateTest implements RewriteTest {

    @Override
    public void defaults(RecipeSpec spec) {
        spec.recipe(new IterateToArrayIterate()).parser(JavaParser.fromJavaVersion().classpath("eclipse-collections"));
    }

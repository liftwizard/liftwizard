...
class Test
{
	...
	private final SortedSet<String> fieldUnmodifiableSortedSet = Collections.unmodifiableSortedSet(
		SortedSets.mutable.with("x", "y")
	);
	private final SortedMap<String, Integer> fieldUnmodifiableSortedMap = Collections.unmodifiableSortedMap(
		SortedMaps.mutable.with("key", 1)
	);
	private final Collection<String> fieldUnmodifiableCollection = Collections.unmodifiableCollection(
		Lists.mutable.with("z")
	);
	...
	void testExplicitGenerics(Object element, Object key, Object value)
	{
		...
		SortedMap<String, Integer> unmodifiableSortedMap = Collections.<String, Integer>unmodifiableSortedMap(
			sortedMap
		);

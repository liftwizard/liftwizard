...
class Test
{
	...
	static <T> Integer injectInto(int identity, Iterable<T> iterable, IntObjectToIntFunction<? super T> fn)
	{
		return 0;
	}

	static <T> Integer injectInto(
		int identity,
		Iterable<T> iterable,
		Function2<? super Integer, ? super T, ? extends Integer> fn
	)
	{
		return 0;
	}

...
{
    private static final MethodMatcher IS_EMPTY_MATCHER = new MethodMatcher("org.eclipse.collections.api..* isEmpty()", true);
    private static final MethodMatcher NOT_EMPTY_MATCHER = new MethodMatcher("org.eclipse.collections.api..* notEmpty()", true);
            ...
            public Expression visitExpression(Expression expression, ExecutionContext ctx)
            {
                ...
                if (IS_EMPTY_MATCHER.matches(methodInvocation))
                {
                    ...
                    return methodInvocation.withName(
                            methodInvocation.getName().withSimpleName("notEmpty")
                ...
                else if (NOT_EMPTY_MATCHER.matches(methodInvocation))
                {
                    ...
                    return methodInvocation.withName(
                            methodInvocation.getName().withSimpleName("isEmpty")
                    ).withPrefix(unary.getPrefix());
                }

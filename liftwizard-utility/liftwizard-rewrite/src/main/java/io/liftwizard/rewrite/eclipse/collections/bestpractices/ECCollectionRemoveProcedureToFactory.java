...
public class ECCollectionRemoveProcedureToFactory extends Recipe {
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new ECCollectionRemoveProcedureToFactoryVisitor();
    }

    private static final class ECCollectionRemoveProcedureToFactoryVisitor extends JavaVisitor<ExecutionContext> {

        @Override
        public J visitNewClass(J.NewClass newClass, ExecutionContext ctx) {
            J.NewClass nc = (J.NewClass) super.visitNewClass(newClass, ctx);

            JavaTemplate collectionRemoveProcedureOnTemplate = JavaTemplate.builder(

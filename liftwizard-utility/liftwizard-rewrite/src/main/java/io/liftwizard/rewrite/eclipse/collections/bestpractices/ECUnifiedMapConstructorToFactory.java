...
public class ECUnifiedMapConstructorToFactory extends Recipe {
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new UnifiedMapConstructorVisitor();
    }

    private static final class UnifiedMapConstructorVisitor extends JavaVisitor<ExecutionContext> {

        @Override
        public J visitNewClass(J.NewClass newClass, ExecutionContext ctx) {
            J.NewClass nc = (J.NewClass) super.visitNewClass(newClass, ctx);

            final JavaTemplate mapsEmptyTemplate = JavaTemplate.builder("Maps.mutable.empty()")
            ...
            if (!UNIFIED_MAP.equals(type.getFullyQualifiedName())) {
                return nc;
            }
            ...
            return mapsEmptyTemplate.apply(this.getCursor(), nc.getCoordinates().replace());
        }

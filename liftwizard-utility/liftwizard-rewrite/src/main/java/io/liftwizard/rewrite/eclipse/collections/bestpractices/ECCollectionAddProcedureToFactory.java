...
public class ECCollectionAddProcedureToFactory extends Recipe {
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JavaVisitor<ExecutionContext>() {
            private final JavaTemplate collectionAddProcedureOnTemplate = JavaTemplate.builder(
                "CollectionAddProcedure.on(#{any()})"
            )
            ...
            public J visitNewClass(J.NewClass newClass, ExecutionContext ctx) {
                ...
                // Check if this is a CollectionAddProcedure constructor

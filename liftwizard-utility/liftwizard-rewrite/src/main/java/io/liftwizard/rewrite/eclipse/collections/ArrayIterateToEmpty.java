...
public class ArrayIterateToEmpty extends Recipe {

    @Override
    public String getDisplayName() {
        return "Replace array null/length checks with ArrayIterate.isEmpty()";
    }

    @Override
    public String getDescription() {
        return "Replaces `array == null || array.length == 0` with `ArrayIterate.isEmpty(array)`.";
    }
            ...
            public Expression visitExpression(Expression expression, ExecutionContext ctx) {
                ...
                if (b.getOperator() == J.Binary.Type.Or) {
                    ...
                    if (leftBinary != null && rightBinary != null) {
                        if (
                            leftBinary.getOperator() == J.Binary.Type.Equal &&
                            rightBinary.getOperator() == J.Binary.Type.Equal
                        ) {
                            ...
                            if (isNullLiteral(leftBinary.getRight()) && isArrayIdentifier(leftBinary.getLeft())) {
                                ...
                                if (
                                    ...
                                    JavaTemplate template = JavaTemplate.builder("ArrayIterate.isEmpty(#{any()})")

...
@RecipeDescriptor(
    ...
    description = "Replace `Collections.unmodifiableCollection()`, `Collections.unmodifiableList()`, `Collections.unmodifiableMap()`, and `Collections.unmodifiableSet()` with Eclipse Collections `asUnmodifiable()` method."
)

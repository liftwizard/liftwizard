...
@RecipeDescriptor(
    ...
    description = "Replace `Collections.synchronizedCollection()`, `Collections.synchronizedList()`, `Collections.synchronizedMap()`, and `Collections.synchronizedSet()` with Eclipse Collections `asSynchronized()` method."
)

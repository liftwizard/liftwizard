...
public final class ObjectMapperConfig
{
    ...
    public static void configure(
            ...
            boolean prettyPrint)
    {
        configure(objectMapper, prettyPrint, true);
    }
    ...
    {
        configure(objectMapper, prettyPrint, failOnUnknownProperties, Include.NON_ABSENT);
    }
    ...
    {
        configure(objectMapper, prettyPrint, failOnUnknownProperties, serializationInclusion, Nulls.AS_EMPTY);
    }

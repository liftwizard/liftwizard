 ...
 */
abstract class AbstractRecordingStatsDClient extends NoOpStatsDClient {

	private final MutableList<Call> calls = Lists.mutable.empty();
	...
	record Call(Kind kind, String name, double value, String[] tags) {}
}

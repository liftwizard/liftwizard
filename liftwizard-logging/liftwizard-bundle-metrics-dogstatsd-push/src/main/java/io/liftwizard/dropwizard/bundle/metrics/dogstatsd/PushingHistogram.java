...
public class PushingHistogram extends Histogram {
	...
	public PushingHistogram(String encodedName, Supplier<StatsDClient> statsdSupplier) {
	...
	public void update(long value) {
		super.update(value);
		this.statsdSupplier.get().histogram(this.tagged.getName(), value, this.tagged.getTags());
	}
}

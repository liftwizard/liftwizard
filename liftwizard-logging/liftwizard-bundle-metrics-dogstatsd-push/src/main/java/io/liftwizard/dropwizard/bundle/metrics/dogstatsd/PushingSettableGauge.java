...
public class PushingSettableGauge<T> extends DefaultSettableGauge<T> {
	...
	public PushingSettableGauge(String name, String[] tags, Supplier<StatsDClient> statsdSupplier) {
	...
	public void setValue(T value) {
		...
		if (value instanceof Number number) {
			this.statsdSupplier.get().gauge(this.name, number.doubleValue(), this.tags);
		}
	}
}

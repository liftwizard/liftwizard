...
import io.liftwizard.model.reladomo.operation.compiler.literal.many.CharacterListLiteralVisitor;
...
import io.liftwizard.model.reladomo.operation.compiler.literal.one.CharacterLiteralVisitor;
...
public class ReladomoOperationBuilderVisitor extends ReladomoOperationThrowingVisitor<Operation>
{
            ...
            String errorContext)
    {
        if (parameterCardinality == ParameterCardinality.ONE)
        {
            ...
            {
                return new CharacterLiteralVisitor(this.finder, errorContext);
            }
        ...
        if (parameterCardinality == ParameterCardinality.MANY)
        {
            ...
            if (attribute instanceof CharAttribute)
            {
                return new CharacterListLiteralVisitor(this.finder, errorContext);
            }
            if (attribute instanceof IntegerAttribute)
            {

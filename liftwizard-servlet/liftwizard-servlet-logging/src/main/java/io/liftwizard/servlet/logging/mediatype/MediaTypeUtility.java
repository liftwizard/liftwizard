...
public final class MediaTypeUtility
{
    ...
    /**
     * Media type application/vnd.api+json (documented here: http://jsonapi.org/)
    ...
    private static final Set<MediaType> READABLE_APP_MEDIA_TYPES = Set.of(
            TEXT_MEDIA_TYPE,
    ...
    public static boolean isReadable(MediaType mediaType)
    {
        ...
        return READABLE_APP_MEDIA_TYPES
                .stream()

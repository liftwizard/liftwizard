...
public class StructuredArgumentsLogstashEncoderLogger implements Consumer<StructuredArguments> {
	...
	private static final Logger LOG = LoggerFactory.getLogger(StructuredArgumentsLogstashEncoderLogger.class);

	@Override
	public void accept(@Nonnull StructuredArguments structuredArguments) {
		LOG.debug(Markers.appendFields(structuredArguments), "Response sent");
	}
}
